...
import 'signuploginpage_model.dart';
export 'signuploginpage_model.dart';

class SignuploginpageWidget extends StatefulWidget {
  const SignuploginpageWidget({super.key});

  static String routeName = 'signuploginpage';
  static String routePath = '/signuploginpage';

  @override
  State<SignuploginpageWidget> createState() => _SignuploginpageWidgetState();
}

class _SignuploginpageWidgetState extends State<SignuploginpageWidget>
    with TickerProviderStateMixin {
  late SignuploginpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignuploginpageModel());
                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/1758679800096-4f5fa9d7-4392-480d-8f4e-7004ad360ad7_1.jpg',
                        width: 120.0,
                        fit: BoxFit.contain,
                      ),
                    ),

...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : SignuploginpageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn
              ? NavBarPage()
              : SignuploginpageWidget(),
        ),
        FFRoute(
          name: SignuploginpageWidget.routeName,
          path: SignuploginpageWidget.routePath,
          builder: (context, params) => SignuploginpageWidget(),
        ),
        FFRoute(
